...
class ReceiverMainPage extends StatefulWidget {
  static String id = 'receiver_main_page';

  @override
  State<ReceiverMainPage> createState() => _ReceiverMainPageState();
}

class _ReceiverMainPageState extends State<ReceiverMainPage> {
  int selectedIndex = 0;
  final screens = [
